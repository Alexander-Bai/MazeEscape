...
static const EIF_TYPE_INDEX egt_13_970 [] = {0xFF01,957,0xFFFF};
static const EIF_TYPE_INDEX egt_14_970 [] = {0xFF01,222,0xFFFF};
...
static const struct desc_info desc_970[] = {
	...
	{EIF_GENERIC(egt_13_970), 13339, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_970), 13340, 0xFFFFFFFF},
};
void Init970(void)
{
	IDSC(desc_970, 0, 969);
	IDSC(desc_970 + 1, 1, 969);
	IDSC(desc_970 + 32, 405, 969);
}
