...
extern EIF_TYPED_VALUE F958_7094(EIF_REFERENCE);
extern EIF_TYPED_VALUE F958_7095(EIF_REFERENCE);
extern EIF_TYPED_VALUE F958_7096(EIF_REFERENCE);
extern EIF_TYPED_VALUE F958_7097(EIF_REFERENCE);
extern EIF_TYPED_VALUE F958_7098(EIF_REFERENCE);
extern EIF_TYPED_VALUE F958_7099(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F958_7093,13241,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F958_7094)
EIF_TYPED_VALUE F958_7094 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 957, Current, 0, 0, 13241);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(957, Current, 13241);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {301,0xFF01,222,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F958_7095)
EIF_TYPED_VALUE F958_7095 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 957, Current, 0, 0, 13242);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(957, Current, 13242);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000127, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 957, Current, 0, 0, 13243);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(957, Current, 13243);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000127, 0,0); /* Result */
...
RTOID (F958_7097)
EIF_TYPED_VALUE F958_7097 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 957, Current, 0, 0, 13244);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(957, Current, 13244);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000127, 0,0); /* Result */
...
EIF_TYPED_VALUE F958_7098 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F958_7098,13246,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F958_7099 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F958_7099,13239,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F958_7100,13240,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit958 (void)
{
	GTCX
	RTOTS (7093,F958_7093)
	RTOTS (7094,F958_7094)
	RTOTS (7095,F958_7095)
	RTOTS (7096,F958_7096)
	RTOTS (7097,F958_7097)
	RTOTS (7098,F958_7098)
	RTOTS (7099,F958_7099)
	RTOTS (7100,F958_7100)
}
